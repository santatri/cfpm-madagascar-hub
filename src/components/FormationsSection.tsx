...
const FormationsSection = () => {
  return (
    <section id="formations" className="py-20 lg:py-28 bg-background">
            ...
            >
              ...
              <div className="divide-y divide-border">
                {category.courses.map((course) => (
                  <div
                    key={course.name}
                    className="px-6 py-4 hover:bg-muted/50 transition-colors flex items-center justify-between gap-4"
                  >
                    ...
                    <div className="text-right">
                      <div className="font-display font-bold text-secondary text-lg">
                        {course.fee}
                      </div>
